...
case class AONE(bs: List[Int]) extends ARexp
case class ACHAR(bs: List[Int], c: Char) extends ARexp
case class AALTS(bs: List[Int], rs: List[ARexp]) extends ARexp
case class ASEQ(bs: List[Int], r1: ARexp, r2: ARexp) extends ARexp
case class ASTAR(bs: List[Int], r: ARexp) extends ARexp
//case class ANTIMES(bs: List[Int], r: ARexp, n: Int) extends ARexp
