...
final class marked$minusintNTIMES$_ {
def args = marked$minusintNTIMES_sc.args$
def scriptPath = """marked-intNTIMES.sc"""
/*<script>*/
...
object marked$minusintNTIMES_sc {
  ...
  lazy val script = new marked$minusintNTIMES$_
...
export marked$minusintNTIMES_sc.script as `marked-intNTIMES`
