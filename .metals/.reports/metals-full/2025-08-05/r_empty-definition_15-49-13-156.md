error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp3.sc:foreach.
...
found definition using fallback; symbol foreach
offset: 4020
...
def test1() = {
  ...
  lexerMarks(br2,s).marks.foreach@@(m => println(s"-$m") )
}
