...
### scala.MatchError: TypeDef(S,TypeBoundsTree(EmptyTree,EmptyTree,EmptyTree)) (of class dotty.tools.dotc.ast.Trees$TypeDef)
...
// if constructing the regular expression with the original syntax.@@
