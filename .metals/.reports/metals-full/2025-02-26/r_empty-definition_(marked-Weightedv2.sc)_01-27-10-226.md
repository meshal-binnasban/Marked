error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/marked-Weightedv2.sc:103
...
def shift[C,S](mark: S, r: Rexpw[C,S], c: Char)(using semiring: Semiring[S]): Rexpw[C,S] = r match {
    case ZEROw => ZEROw
    case ONEw=> ONEw
    case CHARw(f) =>  CHARw(ch, c => semiring.times(mark, f(ch)))
