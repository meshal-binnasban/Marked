error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/marked-Weightedv2.sc:10
...
case c :: cs => fin(cs.foldLeft(shift(true, weighted(r), c))(shift(false, _, _)))
...
val r1=SEQ((CHAR('a')), 10), NTIMES(CHAR('a'), 10))
