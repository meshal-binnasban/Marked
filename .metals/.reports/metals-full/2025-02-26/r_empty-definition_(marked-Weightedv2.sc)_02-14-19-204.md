error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/marked-Weightedv2.sc:145
...
val r1=weighted(SEQ(CHAR('a'), CHAR('b')))(using semiringInt)
println("testing new weighted Marked")
matcher(r1, "ab".toList)(using semiringInt)
