...
def chari[C, S](c: Char)(using semiring: SemiringI[S]): REGW[(Int, C), S] = {
//def chari[S: SemiringI](c: Char): REGW[(Int, Char), S] = {    
    def weight(t: (Int, C)): S = {
      val (pos, x) = t
...
val r = weighted ( SEQ(CHAR('a'), CHAR('b'))) (using semiringInt)
