error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp2.sc:flatMap.
file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp2.sc
empty definition using pc, found symbol in pc: flatMap.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -rexp/r1ms/reshuffle/flatMap.
	 -rexp/r1ms/reshuffle/flatMap#
	 -rexp/r1ms/reshuffle/flatMap().
	 -enumerate/r1ms/reshuffle/flatMap.
	 -enumerate/r1ms/reshuffle/flatMap#
	 -enumerate/r1ms/reshuffle/flatMap().
	 -regenerate/r1ms/reshuffle/flatMap.
	 -regenerate/r1ms/reshuffle/flatMap#
	 -regenerate/r1ms/reshuffle/flatMap().
	 -scala/collection/parallel/CollectionConverters.r1ms.reshuffle.flatMap.
	 -scala/collection/parallel/CollectionConverters.r1ms.reshuffle.flatMap#
	 -scala/collection/parallel/CollectionConverters.r1ms.reshuffle.flatMap().
	 -scala/concurrent/r1ms/reshuffle/flatMap.
	 -scala/concurrent/r1ms/reshuffle/flatMap#
	 -scala/concurrent/r1ms/reshuffle/flatMap().
	 -scala/concurrent/duration/r1ms/reshuffle/flatMap.
	 -scala/concurrent/duration/r1ms/reshuffle/flatMap#
	 -scala/concurrent/duration/r1ms/reshuffle/flatMap().
	 -r1ms/reshuffle/flatMap.
	 -r1ms/reshuffle/flatMap#
	 -r1ms/reshuffle/flatMap().
	 -scala/Predef.r1ms.reshuffle.flatMap.
	 -scala/Predef.r1ms.reshuffle.flatMap#
	 -scala/Predef.r1ms.reshuffle.flatMap().
offset: 2257
uri: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp2.sc
text:
```scala
...
def shift(ms: Marks, r: Rexp): Marks = 
    ...
    if (ms == Nil) (Nil, false)
        ...
        case ALT(r1, r2) =>
            val (lms, c1) = shift(ms <:+> Lf, r1)
            val (rms, c2) = shift(ms <:+> Ri, r2)
         ...
         case SEQ(r1, r2) if nullable(r1) && nullable(r2) =>
            ...
            val r2ms = (r1ms ::: (ms <::+> mkeps2(r1))).reshuffle.flatMap(m => shift(List(m), r2))
        ...
        case SEQ(r1, r2) if nullable(r2) =>
            val r1ms = shift(ms, r1)
            val r2ms = r1ms.reshuffle.flatMap(m => shift(List(m), r2))
            ( (r1ms <::+> mkeps2(r2)) ::: r2ms).reshuffle
           
        case SEQ(r1, r2) =>
            val r1ms = shift(ms, r1)
            val r2ms = r1ms.reshuffle.f@@latMap(m => shift(List(m), r2, c1))
        ...
        case STAR(r, m) =>
         ...
         case STAR(r, m) =>
          ...
          if (rms.isEmpty) {
            ...
            println(s"STAR marks count=${( (rms <:+> En) ::: sms  ).length}")
