error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp2.sc:reshuffle.
file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp2.sc
empty definition using pc, found symbol in pc: reshuffle.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -rexp/r1ms/reshuffle.
	 -enumerate/r1ms/reshuffle.
	 -regenerate/r1ms/reshuffle.
	 -scala/collection/parallel/CollectionConverters.r1ms.reshuffle.
	 -scala/concurrent/r1ms/reshuffle.
	 -scala/concurrent/duration/r1ms/reshuffle.
	 -r1ms/reshuffle.
	 -scala/Predef.r1ms.reshuffle.
offset: 2047
...
def shift(ms: Marks, r: Rexp): Marks = 
    ...
    if (ms == Nil) (Nil, false)
        ...
        case SEQ(r1, r2) if nullable(r2) =>
            val r1ms = shift(ms, r1)
            val r2ms = r1ms.reshuff@@le.flatMap(m => shift(List(m), r2, c1))
