error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/shifts08.sc:map.
...
non-local guesses:
	 ...
	 -rexp/kSplits/map#
	 -rexp/kSplits/map().
	 -enumerate/kSplits/map.
	 -enumerate/kSplits/map#
	 -enumerate/kSplits/map().
	 -regenerate/kSplits/map.
	 -regenerate/kSplits/map#
	 -regenerate/kSplits/map().
	 -kSplits/map.
	 -kSplits/map#
	 -kSplits/map().
	 -scala/Predef.kSplits.map.
	 -scala/Predef.kSplits.map#
	 -scala/Predef.kSplits.map().
offset: 3928
