...
non-local guesses:
	 ...
	 -rexp/markedBits#
	 -rexp/markedBits().
	 -enumerate/markedBits.
	 -enumerate/markedBits#
	 -enumerate/markedBits().
	 -regenerate/markedBits.
	 -regenerate/markedBits#
	 -regenerate/markedBits().
	 -scala/collection/parallel/CollectionConverters.markedBits.
	 -scala/collection/parallel/CollectionConverters.markedBits#
	 -scala/collection/parallel/CollectionConverters.markedBits().
	 -markedBits.
	 -markedBits#
	 -markedBits().
	 -scala/Predef.markedBits.
	 -scala/Predef.markedBits#
	 -scala/Predef.markedBits().
offset: 15362
  ...
  batches.foreach { start =>
    ...
    for (i <- start to end) {
      ...
      for (s <- (regenerate.generate_up_to(alphabet)(10)(r).take(9)) if s != "") {
          val marke@@dBits=lex(r, s).getOrElse(Nil)
