...
def shift(m: Boolean, bs: Bits, r: MRexp, c: Char) : MRexp = (r: @unchecked) match {
  ...
  case MSEQ(cs,r1, r2) if m && mnullable(r1) => 
    MALT(Nil, MSEQ(Nil,shift(true, Nil, fuse(cs,r1), c), shift(fin(r1), Nil , fuse(cs:::mkeps(r1),r2), c)) 
  ...
  case MSTAR(cs,r) if m => MSEQ(Nil ,shift(true, Nil, fuse(List(@@Nx,r), c), MSTAR(Nil,r))
