error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/play_point.sc:65
...
def fin(r: Rexp) : Boolean = r match {
  ...
  case STAR(r) => fin(r)
  case NTIMES(r, n) => if (n == 0 || nullable(r)) fin(r) else false
}
...
def shift(m: Boolean, r: Rexp, c: Char) : Rexp = {
  ...
  case NTIMES(r, n) => if (n == 0) NTIMES(r, n) else 
                    if (m || fin(r)) NTIMES(shift(m || fin(r), r, c), n - 1)
