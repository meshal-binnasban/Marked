error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/Old%20Versions/old%20DrChristian/play_explicit_bits.sc:`<none>`.
file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/Old%20Versions/old%20DrChristian/play_explicit_bits.sc
...
non-local guesses:
	 ...
	 -nullable#
	 -nullable().
	 -scala/Predef.nullable.
	 -scala/Predef.nullable#
	 -scala/Predef.nullable().
offset: 2251
uri: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/Old%20Versions/old%20DrChristian/play_explicit_bits.sc
text:
```scala
//
...
def mkfin(r: Rexp) : Bits = r match {
  ...
  case SEQ(r1, r2) if fin(r1) && null@@able(r2) => mkfin(r1) ++ mkeps(r2)
