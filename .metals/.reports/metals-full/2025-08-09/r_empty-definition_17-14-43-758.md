error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp3.sc:mkString.
...
non-local guesses:
	 ...
	 -rexp/ss/mkString#
	 -rexp/ss/mkString().
	 -enumerate/ss/mkString.
	 -enumerate/ss/mkString#
	 -enumerate/ss/mkString().
	 -regenerate/ss/mkString.
	 -regenerate/ss/mkString#
	 -regenerate/ss/mkString().
	 -scala/collection/parallel/CollectionConverters.ss.mkString.
	 -scala/collection/parallel/CollectionConverters.ss.mkString#
	 -scala/collection/parallel/CollectionConverters.ss.mkString().
	 -ss/mkString.
	 -ss/mkString#
	 -ss/mkString().
	 -scala/Predef.ss.mkString.
	 -scala/Predef.ss.mkString#
	 -scala/Predef.ss.mkString().
offset: 13284
...
def implode(ss: Seq[String]) = ss.mkStri@@ng("\n")
