error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/marked-SemiringLeftMost.sc:67
...
def shift[S](mark: S, re: REG[S], c: Char)(using semiring: SemiringI[S]): REG[S] = {
    re match {
      ...
      case BALT(r1, r2) => altw(shift(mark, r1.re, c), shift(mark, r2.re, c))
