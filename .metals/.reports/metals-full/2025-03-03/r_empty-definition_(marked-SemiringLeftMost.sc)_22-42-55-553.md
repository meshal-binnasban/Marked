error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/marked-SemiringLeftMost.sc:36
...
enum REG[S](using semiring: SemiringI[S]) {
  case BZERO
  case BONE
...
def nullable[S](r: REw[Char,S])(using semiring: SemiringI[S]) : S = r match {
...
def fin[S](r: REw)(using semiring: SemiringI[S]) : S = r match {
  case ZEROw => semiring.zero
  case ONEw => semiring.zero
  case CHARw(f,c) => if (f(c)) semiring.one else semiring.zero
