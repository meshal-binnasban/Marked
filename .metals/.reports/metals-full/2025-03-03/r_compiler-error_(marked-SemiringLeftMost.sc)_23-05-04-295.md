...
### dotty.tools.dotc.core.CyclicReference: Cyclic reference involving module class ammonite
...
action parameters:
uri: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/marked-SemiringLeftMost.sc
text:
```scala
