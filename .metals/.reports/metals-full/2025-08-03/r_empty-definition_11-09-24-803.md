error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp3.sc:`<none>`.
...
non-local guesses:
	 ...
	 -regenerate/nullable#
	 -regenerate/nullable().
	 -scala/collection/parallel/CollectionConverters.nullable.
	 -scala/collection/parallel/CollectionConverters.nullable#
	 -scala/collection/parallel/CollectionConverters.nullable().
	 -nullable.
	 -nullable#
...
def shift(ms: Marks, r: Rexp): Marks = 
    ...
    if (ms == Nil) Nil
        ...
        case ALT(r1, r2) =>
            ( shift(ms <:+> Lf, r1) ::: shift(ms <:+> Ri, r2) )


        case SEQ(r1,r2) => {
            val ms1 = shifts(ms, r1)
            (n@@ullable(r1), nullable(r2)) match {
        ...
        case SEQ(r1, r2) =>
            ...
            r2ms.reshuffle    
         case STAR(r) =>
          val rms = (ms <:+> Nx).flatMap(m => shift(List(m), r)) //removed reshuffle here
          if (rms.isEmpty) {
            (rms)
            } else {
            val sms = shift(rms, STAR(r))
            ( (rms <:+> En) ::: sms  ).reshuffle
            } 
