error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_explicit_bits_list.sc:`<none>`.
...
def shift(m: Boolean, bs: List[Bits], r: Rexp, c: Char) : Rexp = 
  ...
  case ZERO => ZERO
  case ONE => ONE
  case CHAR(d) => if (m && d == c) POINT(bs, CHAR(d)) e@@lse CHAR(d)
