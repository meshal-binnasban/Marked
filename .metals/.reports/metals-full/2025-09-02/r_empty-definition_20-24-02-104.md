error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp3.sc:nonEmpty.
...
non-local guesses:
	 -rexp/emptyMs/nonEmpty.
	 -rexp/emptyMs/nonEmpty#
	 -rexp/emptyMs/nonEmpty().
	 -enumerate/emptyMs/nonEmpty.
	 -enumerate/emptyMs/nonEmpty#
	 -enumerate/emptyMs/nonEmpty().
	 -regenerate/emptyMs/nonEmpty.
	 -regenerate/emptyMs/nonEmpty#
	 -regenerate/emptyMs/nonEmpty().
	 -scala/collection/parallel/CollectionConverters.emptyMs.nonEmpty.
	 -scala/collection/parallel/CollectionConverters.emptyMs.nonEmpty#
	 -scala/collection/parallel/CollectionConverters.emptyMs.nonEmpty().
	 -emptyMs/nonEmpty.
	 -emptyMs/nonEmpty#
	 -emptyMs/nonEmpty().
	 -scala/Predef.emptyMs.nonEmpty.
	 -scala/Predef.emptyMs.nonEmpty#
	 -scala/Predef.emptyMs.nonEmpty().
offset: 2813
...
def shifts(ms: Marks, r: Rexp): Marks = 
  ...
  case NTIMES(r,n) =>
    ...
    val emptyMs= ms.collectEmpty.nonEmpty
    if((ms.collectEmpt@@y.nonEmpty && n != 0) && !nullable(r)){ 
      Nil
      } else{
        if(nullable(r))
