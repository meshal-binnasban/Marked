error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/play_ComplexMarks.sc:60
...
def shift(m: Boolean, re: Rexp, c: Char, bits:List[Int]) : Rexp = {
  ...
  case ONE => ONE
  case CHAR(d,mark) => 
    CHAR(d, Mark(marked = m && d == c, bs = mark.bs ++ bits, color = mark.color))
  case ALT(r1, r2) => 
    ALT(shift(m, r1, c,0::bs)
