error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp3.sc:prune2.
...
found definition using fallback; symbol prune2
offset: 1491
...
def shifts(ms: Marks, r: Rexp): Marks = 
  ...
  case SEQ(r1,r2) => {
    val ms1 = shifts(ms, r1).reshuffle.p@@rune2
    (nullable(r1), nullable(r2)) match {
      case (true, true) => 
        val returned= (ms1 <::+>mkeps2(r2)) ::: ms1.flatMap( m => shifts(List(m), r2))  ::: shifts(ms <::+> mkeps2(r1) ,r2)
