error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp.sc:flatMap.
...
non-local guesses:
	 -rexp/r2Lists/flatMap.
	 -rexp/r2Lists/flatMap#
	 -rexp/r2Lists/flatMap().
	 -enumerate/r2Lists/flatMap.
	 -enumerate/r2Lists/flatMap#
	 -enumerate/r2Lists/flatMap().
	 -regenerate/r2Lists/flatMap.
	 -regenerate/r2Lists/flatMap#
	 -regenerate/r2Lists/flatMap().
	 -scala/collection/parallel/CollectionConverters.r2Lists.flatMap.
	 -scala/collection/parallel/CollectionConverters.r2Lists.flatMap#
	 -scala/collection/parallel/CollectionConverters.r2Lists.flatMap().
	 -scala/concurrent/r2Lists/flatMap.
	 -scala/concurrent/r2Lists/flatMap#
	 -scala/concurrent/r2Lists/flatMap().
	 -scala/concurrent/duration/r2Lists/flatMap.
	 -scala/concurrent/duration/r2Lists/flatMap#
	 -scala/concurrent/duration/r2Lists/flatMap().
	 -r2Lists/flatMap.
	 -r2Lists/flatMap#
	 -r2Lists/flatMap().
	 -scala/Predef.r2Lists.flatMap.
	 -scala/Predef.r2Lists.flatMap#
	 -scala/Predef.r2Lists.flatMap().
offset: 2049
...
def shift(ms: Marks, r: Rexp, consumed: Boolean = false): (Marks, Boolean) = 
    ...
    if (ms == Nil) (Nil, false)
        ...
        case SEQ(r1, r2) if nullable(r1) && nullable(r2) =>
            ...
            val r2Marks = r2Lists.@@flatMap(_._1)
            val c2 = r2Lists.exists(_._2)
            (((r1Marks <::+> mkeps2(r2)).reshuffle ::: r2Marks).reshuffle.prune, c1 || c2)
