error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp.sc:prune.
file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp.sc
empty definition using pc, found symbol in pc: prune.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -rexp/r2ms/reshuffle/prune.
	 -rexp/r2ms/reshuffle/prune#
	 -rexp/r2ms/reshuffle/prune().
	 -enumerate/r2ms/reshuffle/prune.
	 -enumerate/r2ms/reshuffle/prune#
	 -enumerate/r2ms/reshuffle/prune().
	 -regenerate/r2ms/reshuffle/prune.
	 -regenerate/r2ms/reshuffle/prune#
	 -regenerate/r2ms/reshuffle/prune().
	 -scala/collection/parallel/CollectionConverters.r2ms.reshuffle.prune.
	 -scala/collection/parallel/CollectionConverters.r2ms.reshuffle.prune#
	 -scala/collection/parallel/CollectionConverters.r2ms.reshuffle.prune().
	 -scala/concurrent/r2ms/reshuffle/prune.
	 -scala/concurrent/r2ms/reshuffle/prune#
	 -scala/concurrent/r2ms/reshuffle/prune().
	 -scala/concurrent/duration/r2ms/reshuffle/prune.
	 -scala/concurrent/duration/r2ms/reshuffle/prune#
	 -scala/concurrent/duration/r2ms/reshuffle/prune().
	 -r2ms/reshuffle/prune.
	 -r2ms/reshuffle/prune#
	 -r2ms/reshuffle/prune().
	 -scala/Predef.r2ms.reshuffle.prune.
	 -scala/Predef.r2ms.reshuffle.prune#
	 -scala/Predef.r2ms.reshuffle.prune().
offset: 1779
...
def shift(ms: Marks, r: Rexp, consumed: Boolean = false): (Marks, Boolean) = 
    ...
    if (ms == Nil) (Nil, false)
        ...
        case STAR(r, m) =>
            val (rMarks,c)=shift( (ms <:+> Nx ), r, consumed)
                        val (r1ms, c1) = shift(ms, r1, consumed)
            val r2Lists = r1ms.reshuffle.map(m => shift(List(m), r2, c1))
            val r2ms = r2Lists.flatMap(_._1)
            val c2 = r2Lists.exists(_._2)
            ...
            if (c)//maybe change one and have it same as before
                (( shift(rMarks, STAR(r, false), false)._1).reshuffle, true)
                else
