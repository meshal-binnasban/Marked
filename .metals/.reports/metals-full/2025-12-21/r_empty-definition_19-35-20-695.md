error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/shifts_c.sc:foreach.
file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/shifts_c.sc
...
non-local guesses:
	 ...
	 -rexp/ms1/foreach#
	 -rexp/ms1/foreach().
	 -enumerate/ms1/foreach.
	 -enumerate/ms1/foreach#
	 -enumerate/ms1/foreach().
	 -regenerate/ms1/foreach.
	 -regenerate/ms1/foreach#
	 -regenerate/ms1/foreach().
	 -ms1/foreach.
	 -ms1/foreach#
	 -ms1/foreach().
	 -scala/Predef.ms1.foreach.
	 -scala/Predef.ms1.foreach#
	 -scala/Predef.ms1.foreach().
offset: 1231
uri: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/shifts_c.sc
text:
```scala
...
def shifts(ms: Marks, s: String, r: Rexp): Marks = r match {
  ...
  case CHARS(c, id) =>
    ...
    (for {Mark(n, m) <- ms if m < s.length && s(m) == c
    } yield Mark(n, m + 1))
  case ALTS(r1, r2,id) =>
  ...
  case STARSS(r, id) =>
    ...
    ms1.forea@@ch(q => recordSplit(id, q.m))
    if (ms1.isEmpty) Set()
