error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/shifts_map.sc:mapValues.
file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/shifts_map.sc
empty definition using pc, found symbol in pc: mapValues.
empty definition using semanticdb
empty definition using fallback
non-local guesses:
	 -rexp/ms/view/mapValues.
	 -rexp/ms/view/mapValues#
	 -rexp/ms/view/mapValues().
	 -enumerate/ms/view/mapValues.
	 -enumerate/ms/view/mapValues#
	 -enumerate/ms/view/mapValues().
	 -regenerate/ms/view/mapValues.
	 -regenerate/ms/view/mapValues#
	 -regenerate/ms/view/mapValues().
	 -ms/view/mapValues.
	 -ms/view/mapValues#
	 -ms/view/mapValues().
	 -scala/Predef.ms.view.mapValues.
	 -scala/Predef.ms.view.mapValues#
	 -scala/Predef.ms.view.mapValues().
offset: 710
...
extension (ms: Marks)
  ...
  def appendBits(bs: Bits): Marks =
    if (bs.isEmpty) ms else ms.view.mapVa@@lues(p => p.copy(bits = p.bits ++ bs)).toMap
