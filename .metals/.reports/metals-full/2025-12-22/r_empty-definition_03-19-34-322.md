error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/rebit.sc:toList.
file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/rebit.sc
...
non-local guesses:
	 ...
	 -scala/Predef.s.toList().
offset: 6827
uri: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/rebit.sc
text:
```scala
...
def intern(r: Rexp) : ARexp = r match {
  ...
  case STARSS(r,id) => ASTAR(Nil, intern(r))
...
def decode_aux(r: Rexp, bs: Bits) : (Val, Bits) = ((r, bs): @unchecked) match {
  ...
  case (ALTS(r1, r2, id), Lf::bs) => {
    val (v, bs1) = decode_aux(r1, bs)
    (Left(v), bs1)
  }
  case (ALTS(r1, r2, id), Ri::bs) => {
    val (v, bs1) = decode_aux(r2, bs)
    (Right(v), bs1)
  }
  case (SEQ(r1, r2), bs) => {
  ...
  case (STARSS(r1,id), Nx::bs) => {
    val (v, bs1) = decode_aux(r1, bs)
    val (Stars(vs), bs2) = (decode_aux(STARSS(r1,id), bs1)  : @unchecked)
    (Stars(v::vs), bs2)
  }
  case (STARSS(r,id), En::bs) => (Stars(Nil), bs)
...
def matcher (r: Rexp , s: String ) : Boolean =
  bnullable(bders(intern(r), s.toLi@@st))
