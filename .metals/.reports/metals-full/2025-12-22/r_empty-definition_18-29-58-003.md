error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/shifts_map.sc:prefixBit.
file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/shifts_map.sc
empty definition using pc, found symbol in pc: prefixBit.
...
non-local guesses:
	 ...
	 -rexps/ms0/prefixBit#
	 -rexps/ms0/prefixBit().
	 -enumerate/ms0/prefixBit.
	 -enumerate/ms0/prefixBit#
	 -enumerate/ms0/prefixBit().
	 -regenerate/ms0/prefixBit.
	 -regenerate/ms0/prefixBit#
	 -regenerate/ms0/prefixBit().
	 -ms0/prefixBit.
	 -ms0/prefixBit#
	 -ms0/prefixBit().
	 -scala/Predef.ms0.prefixBit.
	 -scala/Predef.ms0.prefixBit#
	 -scala/Predef.ms0.prefixBit().
offset: 2508
...
def shifts1(p: Mark, s: String, r: RexpS): Marks = r match {
  ...
  case NTIMESS(r, n) =>
    ...
    if (n == 0) Map.empty
      ...
      val ms1 = shifts(ms0.@@prefixBit(NxT), s, r)
      ms1.prefixBit(EnT)
    } else {
