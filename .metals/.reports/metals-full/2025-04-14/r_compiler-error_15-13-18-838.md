file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/regenerate.sc
### scala.MatchError: TypeDef(Segments,AppliedTypeTree(Ident(LazyList),List(Ident(SegType)))) (of class dotty.tools.dotc.ast.Trees$TypeDef)
...
action parameters:
offset: 5864
uri: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/regenerate.sc
text:
```scala
//
...
: (Lang, Segments, Option[Int], Option[Int]) = (a, segs, b, c): @unchecked m@@{
