error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/play_point3e.sc:167
file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/play_point3e.sc
...
def mkeps(r: Rexp): List[Int] = r match {
    case ONE => List() 
    case CHAR(_, marked,bs) => List() 
    case POINT(CHAR(_, b), bs) => bs
    case POINT(r , bs) => bs
    case ALT(r1, r2, bs) =>
    ...
    else if (fin(r2)) bs ++  mkeps(r1) ++ mkeps(r2) 
    else List() //bs
    case STAR(r, bs) =>
...
def maintest2() = {
 ...
 // }
  ...
  val string=("a" * i).toList :+'b'
  println(string)
  val finalReg=matcher2(EVIL2, string)
  println(finalReg)
  println( mkeps(finalReg) )
} 
