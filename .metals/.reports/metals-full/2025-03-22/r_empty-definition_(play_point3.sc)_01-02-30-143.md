error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/play_point3.sc:208
...
def pp(e: Rexp) : String = e match {
  ...
  case POINT(CHAR(c,b),tag,bs) => if(tag.head >0) s"•$c\n {bs=$bs , charb=$b  }" else s"$c bs=$bs charb=$b\n" //tag=$tag
