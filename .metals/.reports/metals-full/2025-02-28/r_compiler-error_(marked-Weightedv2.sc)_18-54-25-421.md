...
val a = chari('a')(using sem@@iringIntI)
val b= weighted(CHAR('b'))(using semiringIntI)

println(a)
println(b)

val reg=seqw(a,b)(using semiringIntI)
val s= "qqqabab"
submatcher(reg,s.toList)

//println(matcher(seqw(arb, seqw(reg, arb)), "ab".toList)(using semiringInt))
...
//val r= starw(altw(chari('a')(using semiringILeftmost),chari('b')(using semiringILeftmost)))(using semiringILeftmost)
//
//println(r)

//submatcher(r,s.toList)
//matcher(r, (s.indices zip s).toList)(using semiringILeftmost)
