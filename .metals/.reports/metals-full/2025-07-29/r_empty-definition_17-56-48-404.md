error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp.sc:isEmpty.
...
non-local guesses:
	 ...
	 -rexp/marks/isEmpty#
	 -rexp/marks/isEmpty().
	 -enumerate/marks/isEmpty.
	 -enumerate/marks/isEmpty#
	 -enumerate/marks/isEmpty().
	 -regenerate/marks/isEmpty.
	 -regenerate/marks/isEmpty#
	 -regenerate/marks/isEmpty().
	 -scala/collection/parallel/CollectionConverters.marks.isEmpty.
	 -scala/collection/parallel/CollectionConverters.marks.isEmpty#
	 -scala/collection/parallel/CollectionConverters.marks.isEmpty().
	 -scala/concurrent/marks/isEmpty.
	 -scala/concurrent/marks/isEmpty#
	 -scala/concurrent/marks/isEmpty().
	 -scala/concurrent/duration/marks/isEmpty.
	 -scala/concurrent/duration/marks/isEmpty#
	 -scala/concurrent/duration/marks/isEmpty().
	 -marks/isEmpty.
	 -marks/isEmpty#
	 -marks/isEmpty().
	 -scala/Predef.marks.isEmpty.
	 -scala/Predef.marks.isEmpty#
	 -scala/Predef.marks.isEmpty().
offset: 3711
...
/*         case SEQ(r1, r2) if nullable(r1) && nullable(r2) =>
        ...
        case SEQ(r1, r2) =>
            ...
            val r2ms = r2Lists.flatMap(_._1)
            val c2 = r2Lists.exists(_._2)
            (r2ms.reshuffle, c1 || c2)case STAR(r, m) =>
  def loop(marks: Marks, acc: Marks): (Marks, Boolean) = {
    if (marks.isEmpty) (acc, acc.nonEmpty)
    else {
      val (new@@Marks, consumed) = shift(marks.reshuffle, r, true)  // recurse with consumed = true
      val next = newMarks.filterNot(acc.contains)                 // avoid infinite cycles
      loop(next, acc ::: next)
    }
  }

  val (initMarks, c1) = shift(ms <:+> Nx, r, consumed)
  val (loopedMarks, _) = loop(initMarks, initMarks)
  (loopedMarks ::: (ms <:+> En), loopedMarks.nonEmpty || c1)
