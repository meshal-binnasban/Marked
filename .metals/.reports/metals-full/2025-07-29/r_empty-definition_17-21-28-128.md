error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks.sc:`<none>`.
file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks.sc
...
non-local guesses:
	 ...
	 -regenerate/r1#
	 -regenerate/r1().
	 -scala/collection/parallel/CollectionConverters.r1.
	 -scala/collection/parallel/CollectionConverters.r1#
	 -scala/collection/parallel/CollectionConverters.r1().
	 -scala/concurrent/r1.
	 -scala/concurrent/r1#
	 -scala/concurrent/r1().
	 -scala/concurrent/duration/r1.
	 -scala/concurrent/duration/r1#
	 -scala/concurrent/duration/r1().
	 -r1.
	 -r1#
	 ...
	 -scala/Predef.r1().
offset: 1557
uri: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks.sc
text:
```scala
...
def shift(ms: Marks ,r: Rexp): Marks = 
    ...
    if (ms == Nil) Nil
        ...
        case SEQ(r1, r2) if nullable(r1) =>
            (shift(ms, r@@1).reshuffle ::: (ms <::+> mkeps2(r1))).flatMap(m => shift(List(m), r2)).reshuffle.prune
