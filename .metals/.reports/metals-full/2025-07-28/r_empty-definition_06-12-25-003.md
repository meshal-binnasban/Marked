error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_NMarks_Exp.sc:exists.
...
non-local guesses:
	 ...
	 -rexp/sLists/exists#
	 -rexp/sLists/exists().
	 -enumerate/sLists/exists.
	 -enumerate/sLists/exists#
	 -enumerate/sLists/exists().
	 -regenerate/sLists/exists.
	 -regenerate/sLists/exists#
	 -regenerate/sLists/exists().
	 -scala/collection/parallel/CollectionConverters.sLists.exists.
	 -scala/collection/parallel/CollectionConverters.sLists.exists#
	 -scala/collection/parallel/CollectionConverters.sLists.exists().
	 -scala/concurrent/sLists/exists.
	 -scala/concurrent/sLists/exists#
	 -scala/concurrent/sLists/exists().
	 -scala/concurrent/duration/sLists/exists.
	 -scala/concurrent/duration/sLists/exists#
	 -scala/concurrent/duration/sLists/exists().
	 -sLists/exists.
	 -sLists/exists#
	 -sLists/exists().
	 -scala/Predef.sLists.exists.
	 -scala/Predef.sLists.exists#
	 -scala/Predef.sLists.exists().
offset: 4239
...
/*         case SEQ(r1, r2) if nullable(r1) && nullable(r2) =>
        ...
        case STAR(r, m) =>
            ...
            (ms <:+> En , true)
                ...
                if(c1){
                    val sLists = rMarks.reshuffle.map(m => shift(List(m), STAR(r,false), c1))
                    val sms = sLists.flatMap(_._1)
                    val cs = sLists.exists(_._2)
                    ( ((ms<:+> En) ::: sms ).reshuffle, true)
                }else
                    {
                    val sLists = rMarks.reshuffle.map(m => shift(List(m), STAR(r,false), c1))
                    val sms = sLists.flatMap(_._1)
                    val cs = sLists.exist@@s(_._2)
                    ( ((ms<:+> En) ::: sms ).reshuffle, true)
