error id: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/shifts_sets_lexer.sc:exists.
...
non-local guesses:
	 ...
	 -enumerate/p2/exists#
	 -enumerate/p2/exists().
	 -regenerate/p2/exists.
	 -regenerate/p2/exists#
	 -regenerate/p2/exists().
	 -scala/collection/parallel/CollectionConverters.p2.exists.
	 -scala/collection/parallel/CollectionConverters.p2.exists#
	 -scala/collection/parallel/CollectionConverters.p2.exists().
	 -p2/exists.
	 -p2/exists#
	 -p2/exists().
	 -scala/Predef.p2.exists.
	 -scala/Predef.p2.exists#
	 -scala/Predef.p2.exists().
offset: 2227
  ...
  (nullable(r1), nullable(r2)) match {
    ...
    case (false, true) =>
      ...
      if (p1.exists(_.str == Nil)) p1
        ...
        if (p2.exis@@ts(_.str == Nil)) p2 else p1 ++ p2
      }
