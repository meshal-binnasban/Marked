file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_explicit_bits_seqV1.sc
...
action parameters:
offset: 5545
uri: file://<HOME>/Google%20Drive/KCL/Code%20Playground/Marked/DrChristian/play_explicit_bits_seqV1.sc
text:
```scala
...
// check when ntimes ends then add E ???
  ...
  case NTIMES(r,n) if m => 
    if(n-@@1 ==)
    SEQ(shift(true, bs:+Nx, r, c) , NTIMES(r,n-1)) 
