  ...
  \begin{center}
    ...
    \begin{array}{rcl}
      \der_a\, r          & = &  \der_a\,( ((a)^{*} + (aa)^{*} + (aaa)^{*} + (aaaa)^{*} + (aaaaa)^{*} )^{*}) \\
                          ...
                          & = & ((\der_a\, a \cdot (a)^{*}) + (\der_a\,aa \cdot (aa)^{*}) + (\der_a\,aaa\cdot (aaa)^{*}) \\
                          &   & \quad +\, \dots ) \cdot  r^{*} \\
                          & = & ((\ONE \cdot (a)^{*}) + ((\ONE \cdot a) \cdot (aa)^{*})+ ( (\ONE \cdot aa) \cdot (aaa)^{*}) \\
                          &   &\quad +\, \dots ) \cdot  r^{*}\\
...
Through reasoning and testing, we refined so that it seems that with every input
it produces the possbile values that the input can match the regular expression
%%check here
One resulting difficulty was the
