...
\begin{figure}[ht]
  ...
  Step 2 takes the derivative with respect to $a$; the result is nullable 
  through two branches, yielding bitcodes $[0]$ and $[1]$. 
...
after a character is matched more than once.
...
not yet finished, the initial results are promising. The following subsections
describe these different versions in more detail.
...
We are fairly sure/strongly think that this version produces all possible 
values including the posix value.
