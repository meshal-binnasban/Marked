...
\small
\begin{itemize}
  \item Expression size can grow substantially (especially with Kleene star and sequences and nested constructs).
  \item Derivatives may cause \textbf{size explosion}—expressions grow rapidly, especially with nested sequences or Kleene stars.
