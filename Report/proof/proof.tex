...
\textbf{Unfolding the shifts definition,}
\[
set(shifts(ms,r^n)) = set(shifts(ms,r)) \cup set(shifts(shifts(ms,r), r^{n-1}))
\]
\textbf{By IH on $P(ms,r)= set(shifts(ms,r)) = Strips(L(r))(set\,ms).\\$}

\noindent \textbf{We can use IH on $P(shifts(ms,r), r^{n-1})=set(shifts(shifts(ms,r), r^{n-1})) $ 
since $shifts(ms,r)$ is smaller than $ms$ and $r^{n-1}$ is smaller than $r^{n}$}
\[
=Strips(L(r^{n-1}))(Strips(L(r))(set\,ms)).
\]

\noindent \textbf{so the unfloding of the definition becomes: }
\[
  Strips(L(r))(set\,ms) \cup Strips(L(r^{n-1}))(Strips(L(r))(set\,ms)) \quad (1)
\]


\subsubsection{Using infolding of union}

\noindent \textbf{Unfolding the right hand side of $(1)$  on union:}
\[ 
\begin{array}{llc}
    Strips(L(r^{n-1}))(Strips(L(r))(set\,ms)) = & & \\
    Strips(L(r))( Strips(L(r))(set ms) ) & \cup  & \quad \\
    Strips(L(r))( Strips(L(r))( Strips(L(r))(set ms) ) ) & \cup  & \quad \\
    Strips(L(r))( Strips(L(r))( Strips(L(r))( Strips(L(r)))(set ms) ) ) & \cup  & \quad \\
    \cdots &&\\
\end{array}
\]

\noindent \textbf{Then plug back into  $(1)$}
\[ 
\begin{array}{lll}
    Strips(L(r))(set\,ms) & \cup & \\
    Strips(L(r))( Strips(L(r))(set ms) ) & \cup  & \quad \\
    Strips(L(r))( Strips(L(r))( Strips(L(r))(set ms) ) ) & \cup  & \quad \\
    Strips(L(r))( Strips(L(r))( Strips(L(r))( Strips(L(r)))(set ms) ) ) & \cup  & \quad \\
    \cdots &&\\
\end{array}
\]
\textbf{Which is the definition of $Strips(L(r^n))(set\,ms)$ after unfolding on the union}
