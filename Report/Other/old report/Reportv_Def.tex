...
\begin{definition}[$\shifts$ function]\mbox{}
\begin{center}{
  \renewcommand{\arraystretch}{1.7}
  \begin{tabular}{ccl}
...
As noted earlier, the empty string $\ONE\,$ is not marked. This choice is made to ensure termination of the \shift\ function, in particular in the \STARText\ case: 
