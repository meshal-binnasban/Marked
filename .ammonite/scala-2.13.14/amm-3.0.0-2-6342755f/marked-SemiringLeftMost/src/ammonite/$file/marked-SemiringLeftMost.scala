...
// regular expression
def intern[S](r: Rexp)(using semiring: SemiringI[S]) : REG[Char,S] = r match {
  case ZERO => BZERO()
  case ONE => BONE()
...
def intern2[S](r: Rexp)(using semiring: SemiringI[S]) : REG[Char,S] = BINIT(intern(r))
...
def $main() = { _root_.scala.Iterator[String]() }
  override def toString = "marked$minusSemiringLeftMost"
  /*</generated>*/
}
